...
const ShareButton = ({
  ...
  const shareTitle = `Check out this ${contentType}: ${contentTitle}`;
  const shareText = `Discover this amazing ${contentType} "${contentTitle}" by ${contentPublisher} on HatComics!`;
    ...
    <div className="relative inline-block">
      ...
      {showDropdown && (
        <>
          ...
          {/* Dropdown */}
          <div className="absolute top-full right-0 mt-2 w-48 bg-zinc-800/90 backdrop-blur-sm border border-zinc-700/50 rounded-xl shadow-xl z-20">
            <div className="py-2">
              {/* Native Share (mobile) */}
              <button

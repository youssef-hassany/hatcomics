      ...
      <div className="bg-gradient-to-r from-zinc-900 via-zinc-800 to-zinc-900 text-white py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-4xl font-bold">Stored Comics</h1>
          </div>
          ...
          <div className="flex flex-col gap-4 max-w-4xl">
            ...
            {/* Filter Panel */}
            {showFilters && (
              <div className="bg-zinc-800/50 rounded-lg p-6 border border-zinc-600">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-2 rounded-lg bg-zinc-700 border border-zinc-600 text-white placeholder-zinc-400 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-2 rounded-lg bg-zinc-700 border border-zinc-600 text-white focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500"
                    >
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        {error && (
          <div className="bg-red-900/20 border border-red-500 text-red-200 px-4 py-3 rounded-lg mb-6">
            <p>Error loading stored comics: {error.message}</p>
          </div>
        )}
        ...
        {isLoading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-zinc-300 text-lg">No stored comics found</p>
